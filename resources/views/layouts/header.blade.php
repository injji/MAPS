...
<header class="only_pctab">
    <div class="base_wrap">
        <div class="header_left">
            <ul class="gnb">
                ...
                <li>
                    ...
                    <ul class="lnb lnb01">
                        ...
                        <li>
                            @for ($i = 0; $i < count($categorys)/$colcount; $i++)
                                <ul class="sub_navv">
            ...
            <a href="{{ config('app.pre_url').'://'.config('app.domain.store') }}"><h1></h1></a>
        </div>
        <div class="head_top">
            ...
            @endif
            <div class="select" id="select_kor">
                <!-- <input type="hidden" name="" value="{{ Lang::getLocale() }}"> -->
...
<div id="header" class="only_m">
    ...
    <a href="{{ config('app.pre_url').'://'.config('app.domain.store') }}"><h1><img src="/assets/images/store/logo.png"></h1></a>
    @if(!Auth::guard('user')->check())
    ...
    <div class="menu">
        ...
        <ul>
            ...
            @foreach ($categorys as $code => $category)
                <li>
                    <a href="/categoryinf?category={{$category->id}}">{{ $category->text }}</a>
                </li>
            @endforeach
        </ul>
    </div>
