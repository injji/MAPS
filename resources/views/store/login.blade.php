    ...
    <div class="login">
        ...
        <form id="login-form">
            ...
            <div class="idpw_find">
                ...
                <ul>
                    <li>
                        <a href="{{ route('store.password.reset') }}">
            ...
            <div class="modal-body">
                <ul>
                    ...
                    <li>
                        ...
                        <a href="{{ route('store.register.agree', ['type' => 2]) }}">@lang('button.register')</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="modal-body ">
                <ul>
                    <li>
                        ...
                        <a href="{{ route('store.register.agree', ['type' => 1]) }}">@lang('button.register')</a>
                    </li>

                    <li>
                        <h3>@lang('messages.register.option.byapps')</h3>
                        <p>@lang('messages.register.description.byapps')</p>
                        <a href="{{ route('store.register.register3') }}">@lang('button.register')</a>
                    </li>
                </ul>
            </div>
