                ...
                <div class="mail_form">
                    ...
                    <div class="mail_select">
                        ...
                        <select name="manageremail-domain-select" class="selectpicker" id="selectEmail">
                            <option value="" selected>@lang('sub.regis-email')</option>
                            ...
                            <option class="option" value="1">@lang('form.email.default')</option>
                        </select>
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
    ...
    function register(){
        ...
        $.ajax({
            url : "{{ route('store.register.agent.save') }}",
            type : 'post',
            data : data,            
            success : (response) => {                
                if(response.code == 200){
                    var url = "{{ route('store.register.done', ':account') }}";
