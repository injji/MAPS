            ...
            <div id="skipCont" class="contents">
                ...
                <ul class="list-type-1">
                    ...
                    <li>
                        ...
                        <div class="right">
                            <div class="ipt-type-1 pc-wd-2">
                                <input type="text" name="buyr_name" value="<?php echo Auth::guard('user')->user()->manager_name;?>" readonly />
                            </div>
                        </div>
                    </li>
                    <!-- 주문자 연락처1(buyr_tel1) -->
                    ...
                    <li>
                        ...
                        <div class="right">
                            <div class="ipt-type-1 pc-wd-2">
                                <input type="text" name="buyr_mail" value="<?php echo Auth::guard('user')->user()->manager_email;?>" readonly/>
                            </div>
                        </div>
                    </li>
                </ul>
