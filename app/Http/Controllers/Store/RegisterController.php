...
class RegisterController extends Controller
{
    ...
    {
        return view('store.agree', ['type' => $request->type]);
    }
    ...
    public function register1(Request $request)
    {
        ...
        return view('store.register1', compact('byapps_user','byapps_user_app'));
    }

    public function register2(Request $request)
    {
        return view('store.register2');
    }
    public function register3_byapps(Request $request)
    {
        ...
        return view('store.register3',compact('app_id','byapps_id'));
    }
    ...
    public function done(Request $request)
    {
        ...
        return view('store.register_done', ['account' => $request->account]);
    }
