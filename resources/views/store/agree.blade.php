...
<div class="login_wrap  join_wrap">
    ...
    <div class="login join">
        ...
        <div class="next">
            <a href="{{ route('store.login') }}">@lang('button.login')</a>
...
<script type="text/javascript">    
    ...
    function termModal(type){
        ...
        $.ajax({
            url : "{{ route('store.register.get.term') }}",
            type : 'post',
    ...
    function next(type){
        ...
        if (type == 1)
            location.href = "{{ route('store.register.register1') }}";
        else
            location.href = "{{ route('store.register.register2') }}";     
    }
</script>
@endpush
