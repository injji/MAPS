    ...
    <div>
		...
		<table>
			<tbody>
				<tr>
					<th>비중</th>
	                <td colspan="3"><input type="text" name="weight" value="" style="width: 20%;" /></td>
				</tr>
				<tr>
					<th>항목명</th>
	                ...
	                <td colspan="3">
                        <div class="input-group">
                            <div class="input-group mt-1 mt-md-0 w-100">
                                <input type="text" id="single_date" name="st_date" class="form-control single_date" value="" style="width: 0%;" />
                                <span class="input-group-text">~</span>
                                <input type="text" id="single_date2" name="end_date" class="form-control single_date" value="" style="width: 0%;" />
                            </div>
                        </div>
	                </td>
				</tr>
				<tr>
	                ...
	                <td style="width: 20%;">
	                	<img class="pointer icon-img" src="/assets/images/empty2.png" width="100%" />
	                ...
	                <td style="width: 40%;">
	                	<img class="pointer thumb-img" src="/assets/images/empty2.png" width="100%" />
    ...
    <div class="mt-4">
        <div class="col-12 row p-0 m-0" >
            <div class="col-12 text-right">
                ...
                <button type="button" onclick="saveMainFuncKind()" class="btn btn-secondary waves-effect waves-light">저장</button>
            </div>
        </div>
    </div>
</div>
