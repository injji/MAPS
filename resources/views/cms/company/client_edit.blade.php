	...
	<div class="board_table_info mt-0">
		...
		<div>
			...
			<table>
				<tbody>
					<tr>
						<th style="width: 20%; height:60px">아이디</th>
		...
		<div>
			<div class="my-3"><label class="form-label fs-6">사이트 정보</label></div>
			<table>
				<tbody>
					<tr>
						<th>사이트명</th>
					...
					@foreach($user->site as $key => $item)
                    <?php
                        switch($item->hostname){
                            case 0: $hostname = '독립몰'; break;
                            case 1: $hostname = '카페24'; break;
                            case 2: $hostname = '메이크샵'; break;
                            case 3: $hostname = '고도'; break;
                            default: break;
                        }
                    ?>
						<tr>
